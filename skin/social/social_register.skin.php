...
<div class="sns-wrap d-grid gap-2 mb-4">
	...
	<a href="<?php echo $self_url;?>?provider=kakao&amp;url=<?php echo $urlencode;?>" class="btn btn-light text-dark social_link" style="background-color: #FFEB00" title="카카오"><img src="<?php echo get_social_skin_url().'/img/sns_kakao_s.png' ?>"> 카카오로 로그인</a>
	<?php }     //end if ?>
	<?php if(social_service_check('facebook')){     //페이스북 로그인을 사용한다면 ?>
	<a href="<?php echo $self_url;?>?provider=facebook&amp;url=<?php echo $urlencode;?>" class="btn btn-light text-light social_link" style="background-color: #3B579D" title="페이스북"><img src="<?php echo get_social_skin_url().'/img/sns_facebook_s.png' ?>"> 페이스북으로 로그인</a>
	<?php }     //end if ?>
	<?php if(social_service_check('google')){     //구글 로그인을 사용한다면 ?>
	<a href="<?php echo $self_url;?>?provider=google&amp;url=<?php echo $urlencode;?>" class="btn btn-light text-light social_link" style="background-color: #DB4A3A" title="구글"><img src="<?php echo get_social_skin_url().'/img/sns_google_s.png' ?>"> 구글로 로그인</a>
	<?php }     //end if ?>
	<?php if(social_service_check('twitter')){     //트위터 로그인을 사용한다면 ?>
	<a href="<?php echo $self_url;?>?provider=twitter&amp;url=<?php echo $urlencode;?>" class="btn btn-light text-light social_link" style="background-color: #1DA1F2" title="트위터"><img src="<?php echo get_social_skin_url().'/img/sns_twitter_s.png' ?>"> 트위터로 로그인</a>
	<?php }     //end if ?>
